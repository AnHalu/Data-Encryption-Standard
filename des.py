...
# obj = Des()
#
# pt = "an so 1 , an vo doi , an la chua te"
# pt = pt.encode('utf-8').hex().upper()
#
# pt = pt + '0' * (16 - len(pt) % 16)
# print(pt)
# list = []
# cnt = 0
# while (cnt < len(pt) / 16):
#     list.append(pt[16 * cnt: 16 * (cnt + 1)])
#     cnt += 1
#
# res = ""
# for i in range(0, len(list)):
#     res += obj.thuchienmahoa(list[i], key)
#
# print(res)
#
# listgm = []
# cnt = 0
# while (cnt < len(pt) / 16):
#     listgm.append(res[16 * cnt: 16 * (cnt + 1)])
#     cnt += 1
#
# res = ""
# for i in range(0, len(list)):
